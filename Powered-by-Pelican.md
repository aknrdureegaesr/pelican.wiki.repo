...
- Theme: a fork of pelican-mg that supports isso comments, images lazy loading, pingback/webmention URLs and list of current book readings -> <https://github.com/Lucas-C/pelican-mg>
- Features:
